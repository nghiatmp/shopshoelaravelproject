...
class CategoryController extends Controller
{
    ...
    public function add(){
    	$data['cateparent'] = DB::table('categories_product')->select('id','name')->where('id_parent',0)->get();
    ...
    public function edit($id){
        ...
        $data['cateparent'] = DB::table('categories_product')->select('id','name','id_parent')->where('id_parent',0)->get();
