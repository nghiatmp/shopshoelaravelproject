...
@section('content')
	<div class="content mt-5">
		...
		<div class="row mb-3" style="border-bottom: 1px solid #79F2E7;background-color: #F5F1F1;">
			<b class="ml-5 mt-3 mb-3 " style="font-size: 20px;">Update User</b>
		</div>
		<div class="row">
			...
			<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
				...
				<form action="{{ route('page.postupdate') }}" method="POST" enctype="multipart/form-data">
					@csrf
					<div class="form-group">
						<label for=""><b>Tên tài khoản [&radic;]</b></label>
						<input type="text" name="user" class="form-control" value="{{ $info->fullname }}">
					</div>
					<input type="checkbox" name="checkpass" class="mt-3 mb-5" id="check"> <b>Đổi Mật khẩu</b>
					<div class="form-group">
